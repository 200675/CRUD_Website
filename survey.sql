...
CREATE TABLE IF NOT EXISTS `info` (
  ...
  `fav_anime` varchar(128) NOT NULL,
  `fav_genre` varchar(128) NOT NULL,
  PRIMARY KEY (`name`)
...
INSERT INTO `info` (`name`, `age`, `email`, `fav_anime`, `fav_genre`) VALUES
('Jenna', 17, 'hello@gmail.com', 'something', 'spooky');
--
-- Database: `artgallery`
--
